...
namespace SAESoft.Utilitarios
{
    public class ControlFormularios
    {
        ...
        {
            String[] botones = { "tsbNuevo", "tsbBuscar", "tsbListar", "tsbModificar", "tsbEliminar","tsddbProceso","tsbUpload","tsbPago","tsddbSwitchUser", "tsbSalir" };
            CambiarVisibilidadBotones(botones, toolbar, true);
        }

        public static void BotonesInicialesNavegacion(ToolStrip toolbar)
        {
            String[] botones = { "tsbNuevo", "tsbBuscar", "tsbListar", "tsbModificar", "tsbEliminar","tsddbProceso","tsbUpload","tsbPago","tsddbSwitchUser", "tsbAnterior", "tslIndice", "tsbSiguiente", "tsbSalir" };
            CambiarVisibilidadBotones(botones, toolbar, true);
        }
